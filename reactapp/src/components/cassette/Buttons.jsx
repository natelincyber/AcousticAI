...
class Buttons extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    const pauseIcon = styler(this.buttonsRef.current.querySelector("#pauseIcon"));
    const playPauseBtn = styler(this.buttonsRef.current.querySelector("#playPauseBtn"));
    ...
    if (isPlaying !== prevProps.isPlaying) {
      if (isPlaying) {
        ...
        tween({
          from: { transform: `translate(169.344px, ${this.initialBtnPos}%)` },
          to: { transform: `translate(169.344px, ${this.activeBtnPos}%)` },
          duration: 400,
          ease: easing.linear
        }).start(playPauseBtn);
      } else {
        ...
        tween({
          from: { transform: `translate(169.344px, ${this.activeBtnPos}%)` },
          to: { transform: `translate(169.344px, ${this.initialBtnPos}%)` },
          duration: 400,
          ease: easing.linear
        }).start(playPauseBtn);
      }
    ...
    if (isRecording !== prevProps.isRecording) {
      if (isRecording) {
        tween({
          from: { transform: `translate(0.344px, ${this.initialBtnPos}%)` },
          to: { transform: `translate(0.344px, ${this.activeBtnPos}%)` },
          duration: 400,
          ease: easing.linear
        }).start(recBtn);
      } else {
        tween({
          from: { transform: `translate(0.344px, ${this.activeBtnPos}%)` },
          to: { transform: `translate(0.344px, ${this.initialBtnPos}%)` },
          duration: 400,
          ease: easing.linear
        }).start(recBtn);
      }
